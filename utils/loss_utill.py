...
class VGGPerceptualLoss(torch.nn.Module):
    def __init__(self, resize=True):
        ...
        blocks = []
        blocks.append(torchvision.models.vgg16(weights=tv.VGG16_Weights.DEFAULT).features[:4].eval())
        blocks.append(torchvision.models.vgg16(weights=tv.VGG16_Weights.DEFAULT).features[4:9].eval())
        blocks.append(torchvision.models.vgg16(weights=tv.VGG16_Weights.DEFAULT).features[9:16].eval())
        blocks.append(torchvision.models.vgg16(weights=tv.VGG16_Weights.DEFAULT).features[16:23].eval())
        for bl in blocks:
            for p in bl:
